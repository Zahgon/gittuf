...
// SHA-256.
func (h Hash) IsZero() bool { _ = "STUB: not implemented"; return false }

// Equal compares the hash to another provided Hash to see if they're equal.
func (h Hash) Equal(other Hash) bool { _ = "STUB: not implemented"; return false }
...
// encoded.
func NewHash(h string) (Hash, error) { _ = "STUB: not implemented"; return *new(Hash), nil }
